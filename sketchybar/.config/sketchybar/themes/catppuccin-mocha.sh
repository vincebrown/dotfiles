...
# Transparent Colors
# Hexadecimal alpha values in ARGB format
# - ff = 255 = 100% opacity (fully opaque)
# - e6 = 229 = 90% opacity
# - cc = 204 = 80% opacity
# - b3 = 178 = 70% opacity
# - 99 = 153 = 60% opacity
...
# - 33 = 51 = 20% opacity
# - 1a = 26 = 10% opacity
# - 00 = 0 = 0% opacity (fully transparent)

#90% Mantle
export TRANSPARENT_MANTLE=0xe6181825

# 80% opacity BASE
export TRANSPARENT_BASE=0xe61e1e2e
